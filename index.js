...
[Result] Terkumpul: ${allResults.length} / ${targetTotal} Sesi</pre>`;
        ...
        if (allResults.length > 0) {
            ...
            const summaryLayout = 
                ...
                `<i>Sistem telah menyelesaikan tugas dengan sukses. Jika Anda membutuhkan standarisasi format atau verifikasi live/dead lanjutan, silakan teruskan file output di bawah ini ke bot manajemen @dndcookiesbot agar diproses lebih lanjut.</i>`;
