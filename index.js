...
function showWelcomeBanner() {
 ...
 ▀▀▀▀ ▀─▀ ▀▀▀▀ ▀▀▀▀ ▀─▀ ▀▀▀▀ ▀─▀▀ 
 ───────────────────────────────────${reset}`);
    console.log(`${cyan}${bold} WELCOME OWNER DND STORE - WINDOWS LOCAL SYSTEM${reset}`);
...
function logToPanel(type, data) {
    ...
    if (type === 'SATUAN') {
        ...
        console.log(`${magenta}${bold}└── [DND LOG TRACKER SYSTEM] ──────────────────────────┘${reset}\n`);
    } else if (type === 'BULK') {
        ...
        console.log(`${cyan}${bold}└── [DND LOG TRACKER SYSTEM] ──────────────────────────┘${reset}\n`);
    }
}
...
bot.start(async (ctx) => {
    ...
    const welcomeText = 
        `<b>[ DND ENTERPRISE - CONTROL PANEL ]</b>\n` +
        `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n` +
        `English🇬🇧:\n<i>welcome to bot for hit netflix crack automatically, developed by @csdndstore. Please utilize this utility responsibly and adhere to system regulations to prevent stability issues.</i>\n\nIndoensian🇮🇩\n<i>Selamat datang di bot untuk mendapatkan crack Netflix secara otomatis, yang dikembangkan oleh @csdndstore. Harap gunakan utilitas ini secara bertanggung jawab dan patuhi peraturan sistem untuk mencegah masalah stabilitas..</i>\n\n` +
        `<blockquote>` +
...
async function processNextHit() {
    ...
    try {
        ...
        const layoutInit = `<b>[ DND ENTERPRISE - INITIALIZATION CORE ]</b>\n` +
                           `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n` +
        ...
        while (akunDicoba < accounts.length) {
            ...
            const layoutLogin = `<b>[ DND ENTERPRISE - AUTHENTICATION MODULE ]</b>\n` +
                                `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n` +
            ...
            try {
                ...
                while (shouldContinue) {
                    ...
                    const layoutScraping = `<b>[ DND ENTERPRISE - EXTRACTION ENGINE ]</b>\n` +
                                           `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n` +
...
// Update progress angka untuk /cekantrian
        ...
        const resultText = `<b>[ DND ENTERPRISE - TASK EXECUTION COMPLETED ]</b>\n` +
                           `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n` +
        ...
        if (allResults.length > 0) {
            ...
            await ctx.replyWithDocument(
                ...
                { 
                    caption: `<b>[ DND ENTERPRISE - RESULT SUMMARY ]</b>\n` +
                             `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n` +
                             ...
                             `</blockquote>\n\n` +
                             `English 🇬🇧 :\n` +
                             `<i>Successfully hit cookies, if you want to tidy up the cookie format and check live/dead cookies, please forward this file to the bot @dndcookiesbot so that it can be automatically sorted.</i>\n\n` +
                             `Indonesian 🇮🇩 :\n` +
                             `<i>Berhasil hit cookies, jika ingin merapihkan format cookies dan cek cookies live/dead silahkan forward file ini ke bot @dndcookiesbot agar otomatis di sortir</i>`,
                    parse_mode: 'HTML',
        ...
        try {
            ...
            if (userCurrentMode === 'LINK_TO_COOKIES') {
                const resultText = `✅ successfully logged in and got account cookies!\n\n` +
                                   ...
                                   `Thank you for using this bot, don't forget to follow @csdndstore`;
...
bot.action(/extract_yes_(.+)/, async (ctx) => {
    ...
    if (liveCookiesResults.length > 0) {
        ...
        await ctx.replyWithDocument(
            ...
            { caption: `🍪 <b>Berhasil Ekstrak: ${liveCookiesResults.length} Cookies</b>\n❌ <b>Gagal/Expired: ${deadLinksResults.length} Link</b>\n\nSilahkan gunakan mode fitur convert cookies to link ke bot @dndcookiesbot agar akun disortir oleh bot.`, parse_mode: 'HTML' }
        );
    } else {
...
bot.action('btn_leaderboard', async (ctx) => {
    ...
    let textLeaderboard = `<b>🏆 TOP 10 RANKING CONVERTER DND STORE</b>\n─────────────────────────────\n`;
